...
def main():
    ...
    parser.add_argument("--map-every", type=int, default=0, help="optional ASCII map interval; 0 disables maps")
    parser.add_argument("--log-format", choices=('human', 'json'), default='human',
                        help="Chinese round blocks by default; json is for local analysis tools")
    ...
    journal = ReadableJournal(map_every=args.map_every, output_format=args.log_format)
    try:
